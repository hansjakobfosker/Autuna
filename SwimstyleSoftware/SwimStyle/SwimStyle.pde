...
void bodySegment(float x, float y, float a, float b, float c, float d, float sw) {
  //int angle2;
...
void torsoSegment(float x, float y, float a, float b, float c, float sw) {
  //int angle2;
   float servoA = a;
  strokeWeight(6);
  pushMatrix();
...
void tailSegment(float x, float y, float a, float b, float sw) {
  //int angle2;
    float servoA = a;
  strokeWeight(6);
  pushMatrix();
...
void finSegment(float x, float y, float a, float sw) {
  //int angle2;
    float servoA = a;
  fill(255,0,0);
  strokeWeight(6);
